...
def get_candle(market_code, unit, count):
    if unit == "minutes":
        url = f"https://api.upbit.com/v1/candles/minutes/1?market={market_code}&count={count}"
    else:
        url = f"https://api.upbit.com/v1/candles/{unit}?market={market_code}&count={count}"
